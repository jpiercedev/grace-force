...
/**
 * The mark + wordmark, shared by every screen that renders outside the app
 ...
 * matching the lockup the sidebar carries once you are inside.
 */
 ...
 * form on parchment. The dark surface carries the serif wordmark over a quiet
 * gradient; everything operational stays on the light side. This is the first
 * thing anyone sees of the product, so it borrows the sidebar's silhouette —
 * the one place the app is dark.
 */
    ...
    <div className="flex min-h-dvh flex-col lg:flex-row">
      <aside className="relative isolate overflow-hidden bg-ink px-6 py-7 sm:px-10 lg:flex lg:w-[44%] lg:max-w-2xl lg:flex-col lg:justify-between lg:gap-12 lg:px-14 lg:py-12">
        ...
        <p className="hidden border-t border-ink-line pt-6 text-sm text-slate-200/60 lg:block">
          Relationship management for the ministry team.
        </p>
      </aside>
