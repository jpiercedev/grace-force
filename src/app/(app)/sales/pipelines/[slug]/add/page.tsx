...
export default async function AddToPipelinePage({
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-5">
      ...
      <Card>
        <CardHeader title="Find a person" description="Search by name, email or organization." />
        <CardBody className="space-y-4">
          ...
          <form
            method="get"
            action={`/sales/pipelines/${pipeline.slug}/add`}
                ...
                return (
                  <li key={match.id}>
                    {match.has_open_card ? (
                      ...
                      <Link
                        href={`/sales/pipelines/${pipeline.slug}/add?contact=${match.id}`}
