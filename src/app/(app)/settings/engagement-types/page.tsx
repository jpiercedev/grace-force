...
/**
 * The catalogue of ways a contact can relate to the ministry.
 *
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        ...
        description="The ways a contact can relate to the ministry. One contact can hold several at once."
      />
