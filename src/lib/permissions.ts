...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  admin: 'Full access, including team management, gift records and integrations.',
  staff: 'Can create and edit contacts, engagements, follow-ups, pipelines and proposals.',
  viewer: 'Read-only access to the shared workspace. Cannot change records.',
}
