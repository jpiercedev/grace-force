  ...
  return (
    <form action={formAction} className="space-y-5" noValidate>
      ...
      <p className="text-sm text-slate-600">
        For <span className="font-semibold text-slate-900">{contactDisplayName(contact)}</span>
      </p>
      ...
      <Field label="Details" hint="Optional context for whoever picks this up." error={fieldErrors.details}>
        {(props) => (
